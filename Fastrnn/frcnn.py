...
class FRCNN(object):
    ...
    def get_proposal(self,image):
        ...
        with torch.no_grad():
            ...
            #   rois          建议框的坐标
            #-------------------------------------------------------------#
            roi_cls_locs, _, rois, _ = self.net(images)
            #-------------------------------------------------------------#
            ...
            for i in range(bs):
                ...
                #   第三维度是对应种类的调整参数
                #----------------------------------------------------------#
                roi_cls_loc = roi_cls_loc.view([-1, self.num_classes + 1, 4])
